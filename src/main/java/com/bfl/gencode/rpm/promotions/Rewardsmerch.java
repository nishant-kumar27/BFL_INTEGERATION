...
public class Rewardsmerch {

    @JsonProperty("rewardmerchid")
    private String rewardmerchid;
    ...
    @JsonProperty("rewardmerchid")
    public String getRewardmerchid() {
        return rewardmerchid;
    }

    @JsonProperty("rewardmerchid")
    public void setRewardmerchid(String rewardmerchid) {
        this.rewardmerchid = rewardmerchid;
    }
